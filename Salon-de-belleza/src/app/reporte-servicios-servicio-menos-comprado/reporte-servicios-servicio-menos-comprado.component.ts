...
@Component({
  selector: 'app-reporte-servicios-servicio-menos-comprado',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './reporte-servicios-servicio-menos-comprado.component.html',
  styleUrl: './reporte-servicios-servicio-menos-comprado.component.css'
})
export class ReporteServiciosServicioMenosCompradoComponent implements OnInit {
  ...
  obtenerReporte(): void {
    ...
    this.reporteServiciosService.obtenerServiciosMenosComprados(params).subscribe({
      next: (data) => {
        if (data.length === 0) {
