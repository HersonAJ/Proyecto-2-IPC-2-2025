...
@Component({
  selector: 'app-reporte-marketing-anuncios-mas-mostrados',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './reporte-marketing-anuncios-mas-mostrados.component.html',
  styleUrls: ['./reporte-marketing-anuncios-mas-mostrados.component.css'],
})
export class ReporteMarketingAnunciosMasMostradosComponent implements OnInit {
  reportes: any[] = [];
  mensaje: string = '';
  fechaInicio: string = ''; 
  fechaFin: string = '';
  ...
  obtenerReporte(params: any): void {
    this.reportesMarketingService.obtenerAnunciosMasMostrados(params).subscribe({
      next: (data) => {
        this.reportes = data;
