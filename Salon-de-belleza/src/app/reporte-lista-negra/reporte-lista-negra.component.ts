...
@Component({
  selector: 'app-reporte-lista-negra',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './reporte-lista-negra.component.html',
  styleUrls: ['./reporte-lista-negra.component.css'],
})
export class ReporteListaNegraComponent implements OnInit {
  reportes: any[] = []; 
  mensaje: string = ''; 
  fechaInicio: string = ''; 
  fechaFin: string = ''; 
  ...
  obtenerReporte(params: any): void {
    this.reportesAdminService.obtenerReporteListaNegra(params).subscribe({
      next: (data) => {
        this.reportes = data;
